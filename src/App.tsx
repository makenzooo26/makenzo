        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <PriceCard 
              title="Квадрат"
              price="6 000 ₸"
              features={['Подача в черте города', 'Поездка до 10 км', 'Страховка включена', 'Ожидание до 10-15 мин']}
            />
            <PriceCard 
              title="За город"
              price="10 000 ₸ и выше"
              features={['Приоритетная подача', 'Поездка до 20 км', 'Ожидание до 10-15 мин', 'Любой класс авто']}
              recommended={true}
            />
            <PriceCard 
              title="Меж город"
              price="20 000 ₸ и выше"
              features={['Выезд за МКАД/КАД', 'Поездка до 40 км', 'Фиксированная цена']}
            />
          </div>
